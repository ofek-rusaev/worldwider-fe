  ...
  <section :key="$route.path">
    <div v-if="tour" class="tour-details-container">
      <div class="tour-details-imgs">
        <imgs-gallery class="tour-details-imgs-gallery" :imgList="tour.tourImgUrls" />
      ...
      <div class="tour-details-head">
        <div class="tour-details-info">
          ...
          <div class="tour-details-info-lang">
            <span v-for="(language, idx) in tour.tourGuide.languages" :key="idx">{{ language }},</span>
          </div>
      ...
      <div v-if="isUserAllowedToEdit" class="tour-details-map-search-container">
        <h2 class="tour-details-map-search-list-title">Show your audiance where you will visit:</h2>
        <div class="tour-details-map-search-input">
          <site-input placeholder="Type to search..." @input.native="handleLocation" />
        ...
        <ul class="tour-details-map-search-results">
          <li
            ...
            :key="idx"
          >
            <cube-textbox :text="result.name" mono-color @remove="tour.spots.splice(idx, 1)" />
          </li>
        </ul>
      ...
      <div class="tour-details-profile">
        ...
        <div>
          <h2
            class="tour-details-profile-name"
          >{{ tour.tourGuide.firstName }} {{ tour.tourGuide.lastName }}</h2>
          <span
            class="tour-details-profile-joined"
