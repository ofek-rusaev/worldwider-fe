    ...
    <div class="filter-container">
      ...
      <div class="filter-second-row">
        <div class="filter-input-categories-container">
          <primary-button class="filter-input-categories-button" text="Categories" />
          <site-input
        ...
        <div class="filter-input-price-container">
          <primary-button class="filter-input-price-range" text="Price Range:" />
          <site-input
            type="text"
        ...
        <primary-button class="filter-reset-btn" @click.native="filterBy = {}" text="Reset" />
      </div>
