<template>
  <div class="booking-preview-container">
    <h3>
      &nbsp;
      <router-link :to="`/tours/${booking.tour._id}`">{{ booking.tour.name }} -</router-link>
    ...
    <div class="booking-preview-reservations-container">
      ...
      >
        ...
        <div class="booking-preview-reservations-item-info">
          ...
          <span
            class="booking-preview-reservations-item-info-attendees"
          >Attendees: {{ reservation.attendees }}</span>
          <span class="booking-preview-reservations-item-info-total">${{ reservation.totalCost }}</span>
        </div>
      </div>
    </div>
  </div>
