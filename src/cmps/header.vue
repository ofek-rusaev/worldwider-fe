<template>
  <header class="site-header" :class="{ active: navMenuActive }" :style="headerStyle">
    <router-link to="/home">
      <div
    ...
    <!-- <nav> -->
    <button @click="toggleNavMenu" class="site-header-nav-button">
    ...
    <ul class="site-header-nav">
      ...
      <li class="site-header-nav-item" @click="toggleNavMenu" :class="{ active: navMenuActive }">
        <router-link to="/explore" class="site-header-nav-link">
          <font-awesome-icon @click="resetFilter" :icon="['far', 'compass']" />Explore
        </router-link>
      </li>
      <li class="site-header-nav-item" @click="toggleNavMenu" :class="{ active: navMenuActive }">
        <router-link to="/tours/add" class="site-header-nav-link">Become a guide</router-link>
      </li>
      <!-- <li class="site-header-nav-item" @click="toggleNavMenu" :class="{ active: navMenuActive }">
      ...
      >
        <router-link to="/login" class="site-header-nav-link">Login</router-link>
      </li>
      <li
        v-if="!isLoggedIn"
        class="site-header-nav-item"
        ...
        :class="{ active: navMenuActive }"
      >
        <router-link to="/register" class="site-header-nav-link">Register</router-link>
      </li>
      <li v-if="isLoggedIn" class="site-header-nav-item site-header-user-container">
        <avatar
          user
          size="50px"
